...
inline constexpr std::array<InstructionEncoding, static_cast<size_t>(Instruction::COUNT)> compiletime_instruction_encoding_array = {{
  ...
  InstructionEncoding(Instruction::kpowmod,     0b0110011, -1, 0b000, -1, -1, 0b0000110), // kpowmod
  ...
  InstructionEncoding(Instruction::kandni,      0b0010011, -1, 0b101, -1, -1, 0b0001110), // kandni
